...
public class Article {
    ...
    public void run(){
        ...
        addRemoveGroups(conn, articleId, new String[]{"new-group"},new String[]{"new-group1"});
    ...
    public List<Map<String,String>> getArticles(Jedis conn, int page){
        return getArticles(conn,page,"scores:");
    }
    ...
    public void addRemoveGroups(Jedis conn,String articleId,String[] toAdd,String[] toRemove){
        ...
        for (String add:toAdd){
            conn.sadd("groups:",add,article);
        }
        for(String remove:toRemove){
            conn.srem("groups:",remove,article);
        }
    }
